...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, use_batchnorm=True, ds='cifar10'):
        if ds=='cifar10':
            num_classes = 10
...
def ResNet18(use_batchnorm=True, ds = 'cifar10'):
    return ResNet(BasicBlock, [2,2,2,2], use_batchnorm=use_batchnorm, ds=ds)
