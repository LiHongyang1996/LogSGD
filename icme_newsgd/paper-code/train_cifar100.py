...
def main():
    ...
    task._model.load_state_dict(torch.load(f'/code/checkpoint/resnet_model_weights_100.pth'))

    image_tensor, label = task._test_set[9]

    # 将图像张量转换为PIL图像
    image = transforms.ToPILImage()(image_tensor)
    image.save('/mydata/powersgd_100/powersgd_saved_image_9.png')
    ...
    for epoch in range(config["num_epochs"]):
        ...
        for i, batch in enumerate(train_loader):
            ...
            if i == 0 and config["optimizer_batch_size"] == 10:
                ...
                save_path = "/mydata/powersgd_100/saved_tensor.pt"
                ...
                plt.savefig('/mydata/powersgd_image.png', bbox_inches='tight')
